...
public class ListAdapter extends RecyclerView.Adapter {
    ...
    public ListAdapter(RecipeListFragment.OnRecipeSelectedInterface listener) {
        mListener = listener;
    }
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        //return a new instance of our ViewHolder passing in the inflated itemView
    ...
    private class ListViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ListViewHolder(View itemView) {
            ...
            //set this (our viewholder instance) as onCLickListener to the itemView so when the itemView is clicked we can handle it int he onClick method below
